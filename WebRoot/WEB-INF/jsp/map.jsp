...
<body>
	<div class="map"
		style="height: 400px; height: 600px; margin-top: 10px;"
		id="dituContent"></div>
	</li>
</body>
</html>
<script type="text/javascript">
	...
	function createMap() {
		...
		var point = new BMap.Point(104.067207, 30.598386);//定义一个中心点坐标
	...
	var markerArr = [ {
		title : "成都市晶林科技有限公司",
		content : "成都市高新区益州大道北段15号（成职软件园10层）",
		point : "104.067207|30.598386",
		isOpen : 1,
		icon : {
			w : 21,
			h : 26,
