	...
	$().ready(function () {
		$('#sub').click(function(){
			if($('#rname').val() == "" || $('#rsuggest').val() == "" ){
				...
				fm.action = "${pageContext.request.contextPath }/rest/ttwo/insertTtwo";
			}
		});
    });
</script>
	...
	<div class="news_box">
		...
		<div class="sty_dy_content">
			...
			<form action="" method="post" id="fm"  enctype="multipart/form-data">
				...
				<div class="cen">
					<span>教师名称:</span>
					<input name="rname" id="rname" class="sty_dy_title" placeholder="请输入教师名称"></input>
				</div>
				<span>选择照片:</span><input id="file" type="file" name="file" style="padding-bottom: 5px">
				<div class="cen">
					<span>教师简介:</span>
					<textarea name="rsuggest" id="rsuggest" class="sty_dy_msg" placeholder="请输入教师简介"></textarea>
					</span>
				</div>
				<div class="clear"></div>
