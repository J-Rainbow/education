	...
	$().ready(function () {
		$('#sub').click(function(){
			if($('#ttitle').val() == "" || $('#tcontext').val() == "" ){
				...
				fm.action = "${pageContext.request.contextPath }/rest/tnews/insertTnews";
			}
		});
    });
</script>
	...
	<div class="news_box">
		...
		<div class="sty_dy_content">
			...
			<form action="" id="fm" method="post">
				...
				<div class="cen">
					<span>新闻标题:</span>
					<textarea id="ttitle" name="ttitle" class="sty_dy_title" placeholder="请输入新闻标题"></textarea>
				</div>
				<div class="cen">
					<span>新闻内容:</span>
					<textarea id="tcontext" name="tcontext" class="sty_dy_msg" placeholder="请输入新闻内容"></textarea>
				</div>
				<div class="clear"></div>
