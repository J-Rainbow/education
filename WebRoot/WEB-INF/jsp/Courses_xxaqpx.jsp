...
<body>
			...
			<div id="slideBox" class="slideBox">
				...
				<div class="bd">
					<ul>
						<li><a href="#">
								<div
									style="background: url(images/bananer.png) no-repeat; background-position: center; height: 490px"></div>
						</a></li>
						<li><a href="#">
								<div
									style="background: url(images/banner1.jpg) no-repeat; background-position: center; height: 490px"></div>
						</a></li>
						<li><a href="#">
								<div
									style="background: url(images/bananer.png) no-repeat; background-position: center; height: 490px"></div>
	...
	<!--培训认证样式-->
	<div class="page">
		<div class="px_Certification clearfix margin_bottom">
			<div class="px_title">
				<p class="name">培训认证</p>
			...
			<div class=" Plate">
				<div id="Authenticate_list" class="Authenticate_list">
					<div class="hd">
				...
				<script type="text/javascript">
					jQuery("#Authenticate_list").slide({
						mainCell : ".bd ul",
						effect : "leftLoop",
						vis : 4,
						autoPlay : false
